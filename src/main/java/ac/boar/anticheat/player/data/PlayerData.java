...
public class PlayerData {
    ...
    public int ticksSinceSwimming, ticksSinceCrawling, ticksSinceGliding, ticksSincePowderSnow = 100, ticksSinceScaffolding = 100, ticksSinceShulker = 100, ticksSinceHoneyBlock = 100;
